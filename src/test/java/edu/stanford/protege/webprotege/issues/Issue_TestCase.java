...
public class Issue_TestCase {
    ...
    private final Optional<Long> updatedAt = Optional.of(ISSUE_NUMBER);

    private final ImmutableList<OWLEntity> targetEntities = ImmutableList.of(mock(OWLEntity.class));
    ...
    @Mock
    private final ImmutableList<String> labels = ImmutableList.of("The Label" );

    @Mock
    private final ImmutableList<Comment> comments = ImmutableList.of(mock(Comment.class));
