...
import static edu.stanford.protege.webprotege.obo.OBOTermSynonymScope.BROADER;
import static edu.stanford.protege.webprotege.obo.OBOTermSynonymScope.EXACT;
...
public class OBOTermSynonym_TestCase {
    ...
    private final List<OBOXRef> xrefs = Collections.singletonList(mock(OBOXRef.class));

    private final String name = "The name";

    private final OBOTermSynonymScope scope = EXACT;
