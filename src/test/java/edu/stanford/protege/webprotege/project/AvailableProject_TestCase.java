...
public class AvailableProject_TestCase {
    ...
    private final boolean downloadable = true;

    private final boolean trashable = true;
    ...
    private final long lastOpenedTimestamp = 11L;

    private final boolean inTrash = true;
